...
const services = [
  {
    ...
    description:
      "Zero experience is the only prerequisite. Book individual sessions online, pay with cryptographic security, and receive a digital progress report after every lesson. Our AI concierge handles the logistics — you focus on mastering the craft.",
    features: [
  ...
  },
  {
    ...
    tagline: "Our recommended launch package",
    description:
      "Five sessions with priority scheduling, mock assessment, and a full progress dashboard. Save $25 versus per-session pricing. The ideal start for new learners ready to build real momentum.",
    features: [
  ...
  },
  {
    ...
    description:
      "Ten sessions covering the complete curriculum with two mock road tests. Auto-pay available. Save $100 versus à la carte and progress from novice to test-ready with surgical precision.",
    features: [
