      ...
      <div className="container">
        ...
        >
          ...
          >
            ...
            <BookNowTrigger className="group relative px-16 py-5 bg-accent text-primary rounded-2xl font-black uppercase tracking-widest text-sm overflow-hidden shadow-2xl shadow-accent/20 inline-flex items-center gap-3">
