...
import { Sparkles, CheckCircle2, Bot, Calendar, CreditCard, BarChart3, Bell, Smartphone } from "lucide-react";
...
const features = [
  {
    ...
    description: "Inquire, check availability, or book a session — all through natural conversation. No holds, no voicemail, no friction. The concierge integrates directly with our live calendar, revealing real-time availability instantaneously.",
    highlights: [
  ...
  },
  {
    ...
    description: "Real-time visibility into every open slot. Book a single session or an entire bundle — online, instantaneous. Reschedule with 24-hour notice. Automated confirmations lock your entire cadence.",
    highlights: [
  ...
  },
  {
    ...
    description: "All transactions process through our encrypted portal. Card, debit, or e-transfer — your preference. Automated receipts delivered instantaneously. Bundles unlock savings up to $100.",
    highlights: [
  ...
  },
  {
    ...
    description: "SMS and email alerts fire automatically before every rendezvous. Your instructor's arrival time, your pickup coordinates, your preparation checklist — all delivered before you need to ask.",
    highlights: [
  ...
  },
  {
    ...
    description: "After every session, your instructor logs your performance in our digital nexus. Watch your skills compound session by session. Know the precise moment you're examination-ready.",
    highlights: [
  ...
  },
  {
    ...
    description: "Booking, payments, pulses, and progress — all orchestrated through a single, cohesive experience. No disparate applications, no cross-platform logins. Everything converges seamlessly.",
    highlights: [
  ...
  return (
    <section className="container mb-40 lg:mb-64">
      <div className="text-center mb-16">
        <Badge icon={<Sparkles className="w-4 h-4 text-accent" />}>The full ecosystem</Badge>
        ...
        <p className="text-white/40 text-lg max-w-xl mx-auto mt-4 font-medium">
          Each component converges seamlessly. Book → Pay → Pulse → Track. Zero gaps, zero friction.
        </p>
      </div>
          ...
          >
            ...
            <div className="space-y-2 pt-6 border-t border-white/5 mb-6">
              {item.highlights.map((h, j) => (
                <div key={j} className="flex items-start gap-2 text-xs font-bold text-white/50">
                  <CheckCircle2 className="w-4 h-4 text-accent shrink-0 mt-0.5" /> {h}
                </div>
              ))}
            </div>
