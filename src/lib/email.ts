...
export async function sendBookingConfirmation(booking: Booking) {
  ...
  return resend.emails.send({
    from: "B & H Driving School <kerry@bandhds.co.uk>",
    to: [booking.email],
    subject: `Lesson Confirmed - ${serviceLabel} - B & H Driving School`,
    html: `
      <!DOCTYPE html>
      <html>
        <head>
        ...
        <body>
          <div class="header">
            <div class="logo">B & H <span>Driving</span></div>
          </div>
          <div class="content">
            <h2>Your lesson is confirmed!</h2>
            <p>Hi ${booking.customerName},</p>
            <p>Thank you for booking with B & H Driving School. Your lesson has been confirmed - here's a summary:</p>
            ...
            <p>— Kerry Hare<br>B & H Driving School</p>
          </div>
          <div class="footer">
